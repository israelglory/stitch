...
class StitchApp extends ConsumerWidget {
  const new({this.splash = false, super.key});

  /// Continue the native launch screen with [SplashOverlay]. Off in
  /// tests, which start without one.
  final bool splash;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp.router(
      ...
      builder: (context, child) {
        ...
        return splash ? SplashOverlay(child: app) : app;
      },
    );
  }
}
